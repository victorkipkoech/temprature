...
from word_count import word_to_count
...
class TestWordCount(TestCase):
    ...
    def test_word_occurance3(self):
        self.assertDictEqual(
            ...
            word_to_count("one fish two fish red fish blue fish"),
    ...
    def test_word_occurance4(self):
        self.assertDictEqual(
            ...
            word_to_count('car : carpet as java : javascript!!&@$%^&'),
    ...
    def test_word_occurance5(self):
        self.assertDictEqual(
            {'testing': 2, '1': 1, '2': 1},
            word_to_count('testing 1 2 testing'),
    ...
    def test_word_occurance7(self):
        self.assertDictEqual(
            ...
            word_to_count('¡Hola! ¿Qué tal? Привет!'),
